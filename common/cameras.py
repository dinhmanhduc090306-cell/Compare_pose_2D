...
# ============================================================================
# AP3D Camera Parameters (S1, fs_camera_1 through fs_camera_12)
# Video resolution: 1920x1088
# No lens distortion modeled (set to zero)
# ============================================================================
...
_ap3d_all_cameras = {
    1: {
        'intrinsic': {
            'id': 'fs_camera_1',
            'center': [907.762684, 601.151771],
            'focal_length': [1673.474090, 1672.780681],
        ...
        'extrinsic': {
            'orientation': [0.6689693958, -0.6671221642, 0.2391274998, 0.2241562052],
            'translation': [-4897.890625, -7161.513184, 1548.84314],
        },
    },
    2: {
        'intrinsic': {
            'id': 'fs_camera_2',
            'center': [919.108732, 541.689750],
            'focal_length': [1678.120876, 1677.537969],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [0.5898632015, -0.5436184227, 0.4143676675, 0.4299300526],
            'translation': [-9218.864258, -3783.529297, 1536.206665],
        },
    },
    3: {
        'intrinsic': {
            'id': 'fs_camera_3',
            'center': [951.026990, 500.143267],
            'focal_length': [1675.475139, 1674.815581],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [0.3565989098, -0.3188728411, 0.62725613, 0.6145787795],
            'translation': [-7981.368164, 3933.534912, 1412.778442],
        },
    },
    4: {
        'intrinsic': {
            'id': 'fs_camera_4',
            'center': [965.302810, 524.221621],
            'focal_length': [1674.341321, 1673.753189],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [0.4680598047, -0.4619735533, 0.533156614, 0.5322071779],
            'translation': [-7876.623047, 4096.902832, 1407.950562],
        },
    },
    5: {
        'intrinsic': {
            'id': 'fs_camera_5',
            'center': [964.172835, 522.724320],
            'focal_length': [1681.106527, 1680.656849],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [0.2251871064, -0.1909977692, 0.6850761303, 0.6659439277],
            'translation': [-5346.917969, 7647.055664, 1457.241577],
        },
    },
    6: {
        'intrinsic': {
            'id': 'fs_camera_6',
            'center': [920.555866, 509.009994],
            'focal_length': [1674.742848, 1673.977229],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [0.2834566689, -0.2688534505, 0.654508398, 0.6472935161],
            'translation': [-4878.602539, 8643.151367, 1541.955811],
        },
    },
    7: {
        'intrinsic': {
            'id': 'fs_camera_7',
            'center': [964.204984, 507.158246],
            'focal_length': [1673.242275, 1672.635914],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [-0.1634444871, 0.2166326957, 0.6785899513, 0.682548059],
            'translation': [3947.765137, 9723.418945, 1342.460938],
        },
    },
    8: {
        'intrinsic': {
            'id': 'fs_camera_8',
            'center': [945.927616, 524.303517],
            'focal_length': [1685.606416, 1685.108384],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [-0.348936174, 0.3376796806, 0.5945077406, 0.6409185019],
            'translation': [6330.378906, 6516.788574, 1362.209351],
        },
    },
    9: {
        'intrinsic': {
            'id': 'fs_camera_9',
            'center': [957.403541, 496.332174],
            'focal_length': [1678.230317, 1677.346492],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [-0.2635016363, 0.2642592028, 0.6276595075, 0.6832111709],
            'translation': [7051.42627, 5524.668457, 1427.932129],
        },
    },
    10: {
        'intrinsic': {
            'id': 'fs_camera_10',
            'center': [963.339522, 495.906930],
            'focal_length': [1676.389465, 1675.818457],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [-0.5119518835, 0.5256726436, 0.4720179198, 0.4886436576],
            'translation': [10564.422852, -777.105774, 1432.60437],
        },
    },
    11: {
        'intrinsic': {
            'id': 'fs_camera_11',
            'center': [953.331289, 503.578724],
            'focal_length': [1677.891258, 1677.281000],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [-0.5997709862, 0.6000360602, 0.3772652931, 0.3713521095],
            'translation': [8620.392578, -4133.473633, 1491.508789],
        },
    },
    12: {
        'intrinsic': {
            'id': 'fs_camera_12',
            'center': [919.025401, 520.961939],
            'focal_length': [1682.131758, 1681.704484],
            'radial_distortion': [0.0, 0.0, 0.0],
            'tangential_distortion': [0.0, 0.0],
            'res_w': 1920,
            'res_h': 1088,
        ...
        'extrinsic': {
            'orientation': [0.7064408728, -0.6457570669, -0.2052371143, -0.2044916398],
            'translation': [5193.651855, -8846.013672, 1598.137207],
        },
    },
}


def get_ap3d_cameras(cam_a_idx, cam_b_idx):
    """
    Build AP3D camera intrinsic and extrinsic param structures
    for a 2-camera pair, padded to 4 views: [A, B, A, B].

    Returns:
        ap3d_intrinsic_params: list of 4 dicts (matching h36m_cameras_intrinsic_params format)
        ap3d_extrinsic_params: dict keyed by subject ('S1'), each a list of 4 dicts
    """
    cam_a = _ap3d_all_cameras[cam_a_idx]
    cam_b = _ap3d_all_cameras[cam_b_idx]

    # Intrinsics: [A, B, A, B]
    ap3d_intrinsic_params = [
        cam_a['intrinsic'],
        cam_b['intrinsic'],
        cam_a['intrinsic'],
        cam_b['intrinsic'],
    ...
    # Extrinsics: padded per subject (only S1 for now)
    ap3d_extrinsic_params = {
        'S1': [
            cam_a['extrinsic'],
            cam_b['extrinsic'],
            cam_a['extrinsic'],
    ...
    return ap3d_intrinsic_params, ap3d_extrinsic_params